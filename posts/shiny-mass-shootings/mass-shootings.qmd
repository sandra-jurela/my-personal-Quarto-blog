...
description: "EDA with Shiny app on mass shootings between August 20th, 1982 and August 26th, 2023."
date: "2023-03-01"
categories: 
  - r
  - shiny
...
Last update on September 7, 2023.
:::
...
We have 147 cases, described with 24 variables. At first glance, this dataset clearly needs extensive cleaning.
...
21 of the most recent cases don't have location coordinates at all. We'll address this in the final cleanup step.
...
There are 19 cases with missing location coordinates. In this step we'll convert locations to coordinates with geocoding. and use them later to create a `leaflet` map for a `shiny app`.
...
-   Most shooters were in the 20-24 age group (18.6 %), followed by 40-44 (16.6 %) and 25-29 (15.9 %).
...
-   The data for 2023 is incomplete, with ten cases in the first eight months.
